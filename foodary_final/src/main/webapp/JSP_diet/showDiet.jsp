   ...
   <tr>
      ...
      <th colspan="10">
         ...
         <input 
            ...
            onclick="location.href='/foodary_final/JSP_food/foodUpdateOK.jsp?dietWriteDate=${list[0].dietWriteDate}&dietWriteTime=${list[0].dietWriteTime}'"/>&nbsp;&nbsp;   
         <input 
            type="button" 
            value="삭제하기" 
            style="width: 100px; height: 30px;"
            onclick="location.href='/foodary_final/JSP_food/foodDeleteOK.jsp?idx=${list[0].idx}&dietWriteDate=${list[0].dietWriteDate}&dietWriteTime=${list[0].dietWriteTime}'"/>&nbsp;&nbsp;
         <input 
            type="button" 
            value="이미지로 저장" 
            style="width: 100px; height: 30px;"/>         
