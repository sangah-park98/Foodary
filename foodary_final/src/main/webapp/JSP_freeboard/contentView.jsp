...
<div class="container">
			...
			<tr>
				...
				<td colspan="3" style="font-size: 22pt; padding: 10px;">
					...
					<c:if test="${not empty vo.picture}">
						<img src="/foodary_final/JSP_freeboard/upload/${vo.picture}" style="max-width: 450px; max-height: 300px;">
					</c:if>
				</td>
			</tr>
			<tr class="table-secondary">
				<td colspan="4" align="center">
					...
					<button 
						...
						onclick="location.href='/foodary_final/JSP_freeboard/selectByIdx.jsp?idx=${vo.idx}&currentPage=${currentPage}&job=update'">
						<span style="background: #fafcd9; font-size: 25pt;; font-weight: 800;">수정하기</span></button>&nbsp;&nbsp;&nbsp;
					<button
						type="button" 
						style="background: none; border: 0; cursor: pointer;"
						onclick="location.href='/foodary_final/JSP_freeboard/selectByIdx.jsp?idx=${vo.idx}&currentPage=${currentPage}&job=delete'">
						<span style="background: #fafcd9; font-size: 25pt;; font-weight: 800;">삭제하기</span></button>&nbsp;&nbsp;&nbsp;
					</c:if>
					<button
						type="button" 
						style="background: none; border: 0; cursor: pointer;"
						onclick="location.href='/foodary_final/JSP_freeboard/list.jsp?currentPage=${currentPage}'">
	...
	<br/>
	<!-- 댓글 폼 -->
		<form action="commentOK.jsp" method="post" name="commentForm" onsubmit="return insertCheck()">
				...
				<tr style="margin-bottom: 20px;">
					<td colspan="4" align="center">
						<button 
							...
							style="background: none; border: 0; cursor: pointer;"
							name="commentBtn">
							<span style="background: #fafcd9; font-size: 25pt; font-weight: 800;">댓글저장</span>
						</button>&nbsp;&nbsp;&nbsp;
						<button 
							type="reset" 
							style="background: none; border: 0; cursor: pointer;"
