...
<%@page import="com.foodary.vo.FreeboardCommentList"%>
<%@page import="com.foodary.service.FreeboardService"%>
<%@page import="com.foodary.dao.FreeboardDAO"%>
...
//	contentView.jsp에서 넘어온 경우 메인글을 수정(update.jsp), 삭제(delete.jsp)하는 페이지로 request 영역에
//	저장된 내용을 가지고 넘겨준다.
