		...
		<tr></tr>
			...
			<tr>
				...
				<td align="center" style="width: 610px;">
					...
					<a href="increment.jsp?idx=${vo.idx}&currentPage=${currentPage}" style="color: black; text-decoration: none;">
			...
			<tr>
				...
				<td align="right">
					<button type="button" onclick="location.href='/foodary_final/JSP_freeboard/insert.jsp'" style="background: none; border:0;">
