...
<body>
	<div style="height: 200px; line-height: 70px; display: flex; justify-content: space-between; background: #f0f0f0">
			...
			<div style="text-align: center;">
				<div>
					<a href="./foodWrite.jsp" style="font-size: 20pt; color: black; text-decoration: none;">식단 쓰기</a><br/>
					<a href="./dietList.jsp" style="font-size: 20pt; color: black; text-decoration: none;">식단 보기</a><br/>
					<a href="./list.jsp" style="font-size: 20pt; color: black; text-decoration: none;">자유게시판</a>
				</div>
			</div>
