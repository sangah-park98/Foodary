...
<div class="container">
	...
	<div class="main">	
		<div>
		<form action="registerOK.jsp" method="post" name="registerform">
			<!-- 회원가입에 필요한 기본 정보 -->
			<table cellspacing="20" cellpadding="5" style="width: 1000px; margin-left: auto; margin-right: auto; margin-top: 0px;">
		      <thead>
		         <tr class="info">
		      ...
		      <tr>
		         <th>
		            ...
		            <label><input id="password" type="password" name="password" autocomplete="off"
		            	onkeyup="passwordCheckFunction()" style="font-family: D2Coding; padding-left: 10px;"/></label>
		         </th>
		      </tr>
		      <tr>
		         <th style="width: 300px;">
		            <label for="passwordCheck"><span style="background: lavender; font-size: 22pt;">비밀번호확인</span> :</label>
		      ...
		      <tr>
		         <td colspan="2" align="center">
		            <button id="register" class="btn btn-primary" type="button" value="회원가입" onclick="Noregister()" disabled
		            	style="background: none; border: 0; cursor: pointer;">
		            	<span style="background: #fafcd9; color:black; font-size: 25pt;; font-weight: 800;">회원가입</span>
		            </button>&nbsp;&nbsp;&nbsp;
